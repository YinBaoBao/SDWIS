...
//                    var pt = gridRow[j];
    ...
    this.updateGrid = function(dvalue, method){
        ...
        t.dataCache.setDataStatus(t.currentMakeTime, t.currentVersion, t.currentDateTime, t.currentElement, t.currentHourSpan, 1, GDYB.GridProductClass.datasetGrid, GDYB.GridProductClass.datasetGrid);
        GDYB.GridProductClass.dataStack.push(GDYB.GridProductClass.datasetGrid); //压入堆栈
        GDYB.GridProductClass.updateStationLayer();
    };
