 ...
 * title:短临服务-显示和监测
 */
function DLYBPageClass1() {
	var t = this;
	t.MapLayer = new Map(); //存放地图图层
	this.renderMenu = function(){
		$("#menu_bd").html(`
			<div class="panel panel-default">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion"  href="#ld">
					<h4 class="panel-title" style="width:100%;height:100%;">
						<a href="#">雷达</a>
					</h4>
				</div>
				<div id="ld" class="panel-collapse collapse in">
		            		<div class="panel-body" style="display:flex;flex-flow:row wrap;">
		            			<span>回波强度</span>
	            				<span>回波顶高</span
	            				<span>液态水</span>
	            				<span>风暴追踪</span>
			...
			<div class="panel panel-default">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion"  href="#kgyb">
					<h4 class="panel-title" style="width:100%;height:100%;">
						<a href="#">客观预报</a>
					</h4>
				</div>
				<div id="kgyb" class="panel-collapse collapse in">
		            		<div class="panel-body" style="display:flex;flex-flow:row wrap;">
		            			<span>整点降水</span>
	            				<span>雷暴概率</span>
	            				<span>冰雹概率</span>
			...
			<div class="panel panel-default">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion"  href="#datetime">
					<h4 class="panel-title" style="width:100%;height:100%;">
						<a href="#">时间</a>
					</h4>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading" data-toggle="collapse" data-parent="#accordion"  href="#other">
					<h4 class="panel-title" style="width:100%;height:100%;">
						<a href="#">其它</a>
					</h4>
				</div>
				<div id="other" class="panel-collapse collapse in">
		            		<div class="panel-body" style="display:flex;flex-flow:row wrap;">
		            			<div class="checkbox">
						    <label><input type="checkbox">自动刷新</label>
						 </div>
		            		</div>
	        			</div>
			</div>
		...
		$("#menu_bd").html(`
			<div class="panel panel-default" id="ldsk">
				...
				<div class="panel-body">
					<div class='btn_line'><button id="swan_2dcr">回波强度</button><button id="swan_titan">风暴追踪</button><button id="swan_2det">回波顶高</button></div>
					<div class='btn_line'><button id="swan_2dvil">液态水含量</button><button id="swan_qpf">QPF</button></div>
					<div style="height:20px;width:300px;">
						<div id="lddt" style="position: relative;left:40px;top:0px"></div>
						<div style="position: relative;left:180px;top:-24px" class='btn_line'><button>自动刷新</button></div>
					</div>
				</div>
			</div>
		`); //客观预报
