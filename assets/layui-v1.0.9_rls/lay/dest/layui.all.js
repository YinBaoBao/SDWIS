					...
					n = {
										...
										var g = function(e, t, a) {
												...
												layui.each(k,
													function() {
														var t = i(this),
															l = t.text(),
															r = l.indexOf(e) === -1; ("" === e || (a ? r: e !== l)) && n++,
														a && t[r ? "addClass": "removeClass"](c)
													});
												var l = n === k.length;
												return t(l),
													l
											...
											C = function(e) {
												var i = this.value,
													t = e.keyCode;
												return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && void g(i,
														function(e) {
											...
											k.on("click",
												function() {
													var e = i(this),
														a = e.attr("lay-value"),
														n = v.attr("lay-filter");
													return ! e.hasClass(o) && (v.val(a).removeClass("layui-form-danger"), p.val(e.text()), e.addClass(s).siblings().removeClass(s), layui.event.call(this, l, "select(" + n + ")", {
															elem: v[0],
															value: a,
															othis: t
														}), b(), !1)
						...
						checkbox: function() {
							...
							t.each(function(t, n) {
								...
								var d = l.next("." + u[0]),
									f = i(['<div class="layui-unselect ' + u[0] + (n.checked ? " " + u[1] : "") + (c ? " layui-checkbox-disbaled " + o: "") + '" lay-skin="' + (r || "") + '">', {
						...
						radio: function() {
							...
							a.each(function(a, l) {
								var r = i(this),
									...
									c = this.disabled;
								if ("string" == typeof r.attr("lay-ignore")) return r.show();
								var u = i(['<div class="layui-unselect ' + e + (l.checked ? " " + e + "ed": "") + (c ? " layui-radio-disbaled " + o: "") + '">', '<i class="layui-anim layui-icon">' + t[l.checked ? 0 : 1] + "</i>", "<span>" + (l.title || "未命名") + "</span>", "</div>"].join(""));
								s[0] && s.remove(),
									r.after(u),
									n.call(this, u)
							})
				...
				return layui.each(d,
					function(e, l) {
						var r = i(this),
							...
							u = "",
							d = r.val();
						if (r.removeClass(c), layui.each(o,
								function(e, i) {
									var o = "function" == typeof a[i];
									if (a[i] && (o ? u = a[i](d, l) : !a[i][0].test(d))) return t.msg(u || a[i][1], {
										icon: 5,
										shift: 6
									}),
