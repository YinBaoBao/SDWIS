...
function FilterTool(){
    ...
    this.refresh = function(minValue, maxValue,layer) {
        var t = this;
        ...
        var dgCurrent=null;
        if(layer==undefined){
            dgCurrent = GDYB.GridProductClass.datasetGrid;
        }
        else{
            dgCurrent = layer.datasetGrid;
        }
        ...
        t.datasetGrid = new WeatherMap.DatasetGrid(left, top, right, bottom, rows, cols, 1);
