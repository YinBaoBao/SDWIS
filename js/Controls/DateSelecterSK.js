...
*
* */
function DateSelecterSK(minView,startView,format){
    this.div = null;
	this.leftBtn = null;
	this.rightBtn = null;
	this.leftBtn1 = null;
    ...
    this.createInput = function(){
        var t = this;
        this.div = $("<div style='border:1px solid rgba(65,65,65,0.5);border-radius: 3px;width: 210px;height: 30px;margin-left: -10px;padding-top: 4px;'>");
		this.leftBtn = $("<img>")
			.addClass("dateBtn dateBtnUp")
			.attr("src","imgs/dateBtnUp.png")
			.appendTo(this.div).click(function(){
				t.changeHours(-24*t.intervalMinutes);
			});
		this.rightBtn = $("<img>")
        ...
        this.input = $("<input>")
            .attr({
                "style":"color:#5B5B5B;height:auto;padding:2px;font-size:15px;",
                "type":"text",
