		...
		Init:function(){
			...
			function popup(obj) {
				...
				var html = ''
					...
					+'<div style="text-align:center;margin-top:5px;"><img width="20" height="20" style="margin-top:-3px" src="imgs/monitor/'+attr.img+(attr.isDeal != "未处理"?"_d":"") + '.png"> &nbsp;'+ attr.value + '</div>'
