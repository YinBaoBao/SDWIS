/**
 * Created by wangkun on 2016/7/5.
 * Alter by pope on 2016/8/16.
 */

function QTQLDPageClass(){//强天气——雷达拼图
    this.myDateSelecter = null;
}
QTQLDPageClass.prototype = new PageBase();
var fn = QTQLDPageClass.prototype;
fn.renderMenu = function(){
    var htmlStr = "<div id='div_type' class=''><div class='title1'>要素</div>"
        ...
        +"<div class='btn_line'><button id='swan_2dvil'>液态含水量</button><button id='swan_2dppi0'>基本反射率0.5</button><button id='swan_2dppi1'>基本反射率1.5</button></div>"
        +"<div class='btn_line' style='display:block'><button id='swan_titan'>TITAN</button><button id='swan_trec'>TREC</button><button id='awx_mcs'>MCS</button></div>"
        +"</div>"
        +"<div id='div_Cloud'>"
