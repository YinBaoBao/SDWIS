...
!function (a) {
    var b = {
        ...
        isv: !1
    }, c = {}, d = document, e = "createElement", f = "getElementById", g = "getElementsByTagName", h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "../css/needs/skins/", "/laydate.css"];
    a.laydate = function (b) {
        ...
        c.use("../css/needs/need"), c.use(h[4] + b.defSkin, h[3]), c.skinLink = c.query("#" + h[3])
